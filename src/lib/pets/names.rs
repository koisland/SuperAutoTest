...
impl Display for PetName {
    ...
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            PetName::Swordfish => write!(f, "Swordfish"),
