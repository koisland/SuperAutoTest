...
fn test_battle_frilled_dragon_team() {
    ...
    let mut team = test_frilled_dragon_team("self");
    let mut enemy_team = test_ant_team("enemy");

    assert_eq!(
        team.get_all_pets().last().unwrap().stats,
        Statistics {
            attack: 1,
            health: 1
        }
...
fn test_battle_frog_team() {
    ...
    let mut team = test_frog_team("self");
    let mut enemy_team = test_ant_team("enemy");
...
fn test_battle_moth_team() {
    ...
    let mut team = test_moth_team("self");
    let mut enemy_team = test_ant_team("enemy");
...
fn test_battle_hummingbird_team() {
    ...
    let mut team = test_hummingbird_team("self");
    let mut enemy_team = test_ant_team("enemy");
...
fn test_battle_iguana_seahorse_team() {
    ...
    let mut team = test_iguana_seahorse_team("self");
    let mut enemy_team = test_cricket_horse_team("enemy");
