...
fn test_battle_croc_team() {
    ...
    let mut team = test_crocodile_team("self");
    let mut enemy_team = test_crocodile_team("enemy");
...
fn test_battle_rhino_team() {
    ...
    let mut team = test_rhino_team("self");
...
fn test_battle_scorpion_team() {
    ...
    let mut team = test_scorpion_team("self");
...
fn test_battle_shark_team() {
    ...
    let mut team = test_shark_team("self");
    let mut enemy_team = test_shark_team("enemy");
...
fn test_battle_turkey_team() {
    ...
    let mut team = test_turkey_team("self");
    let mut enemy_team = test_turkey_team("enemy");

    team.fight(&mut enemy_team);
    team.fight(&mut enemy_team);

    // Cricket faints, zombie version spawned, and it gains (3,3) (lvl.1 turkey)
    let zombie_cricket = team.get_next_pet().unwrap();
    assert_eq!(
